    ...
    <div class="main-grid gap-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="rounded-lg border-2 border-color p-6 overflow-x-auto">
        <div class="flex items-center justify-between mb-6">
          <h2 class="text-2xl font-semibold text-color">Manage Borrowed Books</h2>
        </div>
        <table class="w-full text-left table-auto">
          ...
          <tbody>
            <tr v-for="book in rowData" :key="book.id" class="border-b border-color hover:bg-gray-100 transition-colors duration-300">
...
const rowData = ref<BorrowedBook[]>([])
