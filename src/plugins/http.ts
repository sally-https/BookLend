...
// public: https://mybook.use-api-services.com/api
// local:  http://127.0.0.1:8000/api
const baseURL: string = 'https://mybook.use-api-services.com/api'
...
export const userDelete = async (endpoint: string, data: any = {}): Promise<any> => {
  return makeRequest({ method: 'DELETE', endpoint, data }, true)
}
